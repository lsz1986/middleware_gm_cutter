#ifndef __AFX_ETHINFO_H__
#define __AFX_ETHINFO_H__
...
private:
	...
	char* DWORDToChar(const DWORD diskdata [256], const int firstIndex, const int lastIndex);
...
public:
	CString m_sEthMacAddr;
	CString m_sHdSerial;
	CString m_sCPUID;

};

#endif /*__AFX_ETHINFO_H__*/
